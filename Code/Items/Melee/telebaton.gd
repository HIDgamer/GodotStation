...
@onready var opened: CollisionPolygon2D = $InteractionArea/Opened
@onready var closed: CollisionPolygon2D = $InteractionArea/Closed
...
func toggle_baton(method: String = "unknown"):
	match method:
		"open":
			open = true
			force = 20
